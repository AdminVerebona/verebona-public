 ...
 * in-page section links (Pourquoi / Fonctionnalités / Tarifs / FAQ) route to
...
export function useNav() {
  ...
  const navPourquoi = () => goToAnchor('pourquoi')
  ...
  return {
    ...
    navPourquoi, navFeatures, navPricing, navFaq, navCasUsage,
